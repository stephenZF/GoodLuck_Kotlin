...
import com.goodluck.base.BuildConfig;
...
//                        sb.append(aHead).append(LINE_SEP);
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = InitConfigKt.sApplication
                    .getPackageManager()
                    .getPackageInfo(InitConfigKt.sApplication.getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private String  mGlobalTag         = "XiangLiao";  // The global tag of log.
        private boolean mTagIsSpace        = false;  // The global tag is space.
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && InitConfigKt.sApplication.getExternalCacheDir() != null)
                mDefaultDir = InitConfigKt.sApplication.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = InitConfigKt.sApplication.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
