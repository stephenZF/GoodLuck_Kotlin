...
import com.goodluck.module_mine.viewmodel.UserFollowersViewModel
...
class UserFollowersActivity :
    BaseActivity<UserFollowersViewModel, com.goodluck.module_mine.databinding.MineActivityUserFollowersBinding>(),
    OnItemClickListener,
